...
def linear_layer(
    ...
    """
    print("XXXXXXXXXXXXXXXXXXX input_size", input_size, "\nXXXXXXXXXXXXXXXXXXX output_size", output_size, "\nXXXXXXXXXXXXXXXXXXX kernel_init", kernel_init, "\nXXXXXXXXXXXXXXXXXXX kernel_gain", kernel_gain, "\nXXXXXXXXXXXXXXXXXXX bias_init", bias_init)
    ...
    if (
        ...
        print("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX LAYER XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
    else:
